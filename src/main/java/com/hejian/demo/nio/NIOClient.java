...
public class NIOClient {
    ...
    public void listen() throws IOException {
        ...
        while (true) {
            ...
            // 这是获取注册到该复用器中的通道的相关事件，获取的过程也就是select()方法遍历获取事件不同的系统、jdk也不同，如果是epoll则是从一个fd就绪队列获取
            ...
            while (ite.hasNext()) {
                ...
                if (key.isConnectable()) {
                    ...
                    // 判断该channel的channelEvent事件类型，也就是reactor模式中的分发器，如果把里面处理过程进行封装就是处理器了
